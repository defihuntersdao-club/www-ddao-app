          <!-- modal-->
          <section class="modal fade" id="stake_v02" tabindex="-1" aria-hidden="true">
                <div class="modal-dialog modal-custom-size modal-dialog-centered">
                  <div class="modal-content">
                        <div class="modal-header">
                          <h5 class="modal-title">Stake LP <span id=stake_v02_pair></span></h5>
                          <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                        </div>


                        <div class="modal-body">
                                <p class="modal-text">You can stake or unstake your LP.</p>
...
print "<input class=i type=number value=0 min=0 step=0.000000000000000001 max=0 id=modal_stake_v02_amount>";
print "<br>";
...
print "<div class=\"col-8 r\">";
    ...
    print "<span class=\"lp_balance\" id=modal_stake_v02_balance>-</span>";
    print "</div>";
/*
...
//print "<br>";
    ...
    print "</div>";
    print "<div class=\"col-9 r\">";
    print "<span class=\"lp_allowance\" id=modal_stake_v02_allowance>-</span>";
//print " LP</nobr> ";
    print "</div>";
/*
    print "<div class=\"col-2 l\">";
...
print "<div class=\"col-4 c pers_btn\">";
    ...
    print "<button class=\"btn-primary pers\" onclick=\"stake2_amount_set(25);\">&nbsp;25%</button> ";
//print "</div>";
//print "<div class=\"col-2 c\">";
    print "<button class=\"btn-primary pers\" onclick=\"stake2_amount_set(50);\">&nbsp;50%</button> ";
//print "</div>";
print "<br>";
//print "<div class=\"col-2 c\">";
    print "<button class=\"btn-primary pers\" onclick=\"stake2_amount_set(75);\">&nbsp;75%</button> ";
//print "</div>";

//print "<div class=\"col-2 c\">";
//    print "<button class=\"btn-xs btn-primary pers\" onclick=\"stake2_amount_set(100);\">100%</button> ";
    print "<button class=\"btn-primary pers\" onclick=\"stake2_amount_set(100);\">100%</button> ";
print "</div>";
print "</div>";
...
print "<center>";
print "<button class=\"btn btn-primary\" style=\"width:90%;\" id=\"stake_v02_stake_btn\" onclick=\"stake_v02_staking();\">Stake</button>";
print "</center>";
//print "<br>";
//print "asdfkjasdf";
print "</div>";
