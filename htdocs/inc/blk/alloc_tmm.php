...
<tr>
<td>Balance</td>
<td class="c tmm_matic_balance"></td>
<td class="c tmm_bsc_balance"><td>
</tr>

<tr>
<td>Allowance</td>
<td class="c tmm_matic_allowance"></td>
<td class="c tmm_bsc_allowance"><td>
</tr>

<tr>
<td>Allocation</td>
<td class="c tmm_matic_alloc"></td>
<td class="c tmm_bsc_alloc"><td>
</tr>

<!--
<tr>
<td>Action</td>
<td class="c tmm_matic_act"></td>
<td class="c tmm_bsc_act"><td>
</tr>
-->

<tr>
<td>&nbsp;</td>
<td class="c" id="tmm_matic_btn">
</td>
<td class="c" id="tmm_bsc_btn">
<td>
</tr>
						...
						<div class="tokens-tf__text"><centeR>Now minimal amount: <span id=tmm_minimal>-</span></center></div>
...
?>
						<div id=tmm_wal_connect>
						<button  class="art-button-2 btn btn-primary wallet_connect2 w-100" onclick="onConnect();">                                                                      
                                                          Connect wallet                                                                                                                  
                                                </button>
						</div>

						<div class="d-none" id=tmm_btn_amount>
						<a href="#" class="art-button btn btn-primary w-100" data-bs-toggle="modal" data-bs-target="#tmm_modal">Enter Amount</a>
						</div>
<?php
}
?>
